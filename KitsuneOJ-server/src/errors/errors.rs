...
use crate::errors::protocol::markdown::MARKDOWN_RENDER_FAILED;
use crate::errors::protocol::oauth::{OAUTH_ACCOUNT_ALREADY_LINKED, OAUTH_CANNOT_UNLINK_LAST_CONNECTION, OAUTH_CONNECTION_NOT_FOUND, OAUTH_INVALID_AUTH_URL, OAUTH_INVALID_IMAGE_URL, OAUTH_INVALID_REDIRECT_URL, OAUTH_INVALID_TOKEN_URL, OAUTH_TOKEN_EXCHANGE_FAILED, OAUTH_USER_INFO_FETCH_FAILED, OAUTH_USER_INFO_PARSE_FAILED};
use crate::errors::protocol::password::{PASSWORD_ALREADY_SET, PASSWORD_CANNOT_UPDATE_OAUTH_ONLY, PASSWORD_INCORRECT, PASSWORD_NEW_PASSWORD_MISSING, PASSWORD_REQUIRED_FOR_UPDATE};
use crate::errors::protocol::post::POST_NOT_FOUND;
use crate::errors::protocol::report::REPORT_NOT_FOUND;
use crate::errors::protocol::session::{SESSION_EXPIRED, SESSION_INVALID_USER_ID, SESSION_NOT_FOUND};
...
impl IntoResponse for Errors {
    fn into_response(self) -> Response {
        ...
        let (status, code, details) = match self {
            ...
            Errors::DocumentAlreadyExists => (StatusCode::CONFLICT, DOCUMENT_ALREADY_EXISTS, None),
